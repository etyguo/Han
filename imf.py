...
def make_ncluster(n, massfunc='kroupa', verbose=False, silent=False, **kwargs):
    """
    Sample from an IMF to make a cluster with a specified N.  Returns the masses of all stars in the cluster
    ...
    if not silent: print "Total cluster mass is %g" % (mtot)
